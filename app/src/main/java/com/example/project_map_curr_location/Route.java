...
public class Route {
    ...
    private void drawPath(String  result, boolean withSteps) throws JSONException {

//        try {

            JSONObject json = new JSONObject(result);

        // ВОТ ЗДЕСЬ ОШИБКА ЧТО ДЕЛАТЬ       Я ЗАПУТАЛСЯ АААААААААААААААААААААААААААААААААААААААА
